...
export const FUTURE_UNDERGRADUATE = [
  { title: 'Artificial Intelligence', status: 'Coming Soon' },
  { title: 'International Hotel Management', status: 'Coming Soon' },
  { title: 'Korean for Academic Purposes', status: 'Coming Soon' },
];
